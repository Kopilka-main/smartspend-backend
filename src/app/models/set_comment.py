...
class SetComment(Base):
    __tablename__ = "set_comments"
    ...
    parent: Mapped["SetComment | None"] = relationship(
        remote_side="SetComment.id", foreign_keys="SetComment.parent_id", lazy="noload"
    )
